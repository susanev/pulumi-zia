...
func LookupDLPNotificationTemplates(ctx *pulumi.Context, args *LookupDLPNotificationTemplatesArgs, opts ...pulumi.InvokeOption) (*LookupDLPNotificationTemplatesResult, error) {
	...
	err := ctx.Invoke("zia:DLP/getDLPNotificationTemplates:getDLPNotificationTemplates", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o LookupDLPNotificationTemplatesResultOutput) PlainTestMessage() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDLPNotificationTemplatesResult) string { return v.PlainTestMessage }).(pulumi.StringOutput)
}
