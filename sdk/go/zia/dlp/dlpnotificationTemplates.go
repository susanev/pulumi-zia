...
func NewDLPNotificationTemplates(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zia:DLP/dLPNotificationTemplates:DLPNotificationTemplates", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDLPNotificationTemplates(ctx *pulumi.Context,
	...
	var resource DLPNotificationTemplates
	err := ctx.ReadResource("zia:DLP/dLPNotificationTemplates:DLPNotificationTemplates", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The Subject line that is displayed within the DLP notification email.
func (o DLPNotificationTemplatesOutput) Subject() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DLPNotificationTemplates) pulumi.StringPtrOutput { return v.Subject }).(pulumi.StringPtrOutput)
}
