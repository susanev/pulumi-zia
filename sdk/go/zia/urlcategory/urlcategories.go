...
func NewURLCategories(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zia:URLCategory/uRLCategories:URLCategories", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetURLCategories(ctx *pulumi.Context,
	...
	var resource URLCategories
	err := ctx.ReadResource("zia:URLCategory/uRLCategories:URLCategories", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Value is set to false for custom URL category when due to scope user does not have edit permission
func (o URLCategoriesOutput) Editable() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *URLCategories) pulumi.BoolPtrOutput { return v.Editable }).(pulumi.BoolPtrOutput)
}
...
func (o URLCategoriesOutput) UrlCategoryId() pulumi.StringOutput {
	return o.ApplyT(func(v *URLCategories) pulumi.StringOutput { return v.UrlCategoryId }).(pulumi.StringOutput)
}
