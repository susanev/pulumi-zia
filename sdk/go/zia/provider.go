...
func NewProvider(ctx *pulumi.Context,
	...
	if isZero(args.ApiKey) {
		args.ApiKey = pulumi.StringPtr(getEnvOrDefault("", nil, "ZIA_API_KEY").(string))
	}
	if isZero(args.Password) {
		args.Password = pulumi.StringPtr(getEnvOrDefault("", nil, "ZIA_PASSWORD").(string))
	}
	if isZero(args.Username) {
		args.Username = pulumi.StringPtr(getEnvOrDefault("", nil, "ZIA_USERNAME").(string))
	}
	if isZero(args.ZiaCloud) {
		args.ZiaCloud = pulumi.StringPtr(getEnvOrDefault("", nil, "ZIA_CLOUD").(string))
	}
	if args.ApiKey != nil {
