...
type RuleLabels struct {
	...
	CreatedBies RuleLabelsCreatedByArrayOutput `pulumi:"createdBies"`
	...
	LastModifiedBies RuleLabelsLastModifiedByArrayOutput `pulumi:"lastModifiedBies"`
...
func NewRuleLabels(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zia:RuleLabels/ruleLabels:RuleLabels", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuleLabels(ctx *pulumi.Context,
	...
	var resource RuleLabels
	err := ctx.ReadResource("zia:RuleLabels/ruleLabels:RuleLabels", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ruleLabelsState struct {
	// The admin that created the rule label. This is a read-only field. Ignored by PUT requests.
	CreatedBies []RuleLabelsCreatedBy `pulumi:"createdBies"`
	// The rule label description.
	Description *string `pulumi:"description"`
	// The admin that modified the rule label last. This is a read-only field. Ignored by PUT requests.
	LastModifiedBies []RuleLabelsLastModifiedBy `pulumi:"lastModifiedBies"`
	// Timestamp when the rule lable was last modified. This is a read-only field. Ignored by PUT and DELETE requests.
...
type RuleLabelsState struct {
	// The admin that created the rule label. This is a read-only field. Ignored by PUT requests.
	CreatedBies RuleLabelsCreatedByArrayInput
	// The rule label description.
	Description pulumi.StringPtrInput
	// The admin that modified the rule label last. This is a read-only field. Ignored by PUT requests.
	LastModifiedBies RuleLabelsLastModifiedByArrayInput
	// Timestamp when the rule lable was last modified. This is a read-only field. Ignored by PUT and DELETE requests.
...
// The admin that created the rule label. This is a read-only field. Ignored by PUT requests.
func (o RuleLabelsOutput) CreatedBies() RuleLabelsCreatedByArrayOutput {
	return o.ApplyT(func(v *RuleLabels) RuleLabelsCreatedByArrayOutput { return v.CreatedBies }).(RuleLabelsCreatedByArrayOutput)
}
...
// The admin that modified the rule label last. This is a read-only field. Ignored by PUT requests.
func (o RuleLabelsOutput) LastModifiedBies() RuleLabelsLastModifiedByArrayOutput {
	return o.ApplyT(func(v *RuleLabels) RuleLabelsLastModifiedByArrayOutput { return v.LastModifiedBies }).(RuleLabelsLastModifiedByArrayOutput)
}

// Timestamp when the rule lable was last modified. This is a read-only field. Ignored by PUT and DELETE requests.
func (o RuleLabelsOutput) LastModifiedTime() pulumi.IntOutput {
	return o.ApplyT(func(v *RuleLabels) pulumi.IntOutput { return v.LastModifiedTime }).(pulumi.IntOutput)
}
...
func (o RuleLabelsOutput) ReferencedRuleCount() pulumi.IntOutput {
	return o.ApplyT(func(v *RuleLabels) pulumi.IntOutput { return v.ReferencedRuleCount }).(pulumi.IntOutput)
}
