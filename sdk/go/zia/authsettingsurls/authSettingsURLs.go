...
func NewAuthSettingsURLs(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zia:AuthSettingsUrls/authSettingsURLs:AuthSettingsURLs", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthSettingsURLs(ctx *pulumi.Context,
	...
	var resource AuthSettingsURLs
	err := ctx.ReadResource("zia:AuthSettingsUrls/authSettingsURLs:AuthSettingsURLs", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
