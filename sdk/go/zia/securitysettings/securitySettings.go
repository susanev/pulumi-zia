...
func NewSecuritySettings(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zia:SecuritySettings/securitySettings:SecuritySettings", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecuritySettings(ctx *pulumi.Context,
	...
	var resource SecuritySettings
	err := ctx.ReadResource("zia:SecuritySettings/securitySettings:SecuritySettings", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
