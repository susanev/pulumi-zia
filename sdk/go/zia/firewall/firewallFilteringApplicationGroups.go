...
func NewFirewallFilteringApplicationGroups(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zia:Firewall/firewallFilteringApplicationGroups:FirewallFilteringApplicationGroups", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallFilteringApplicationGroups(ctx *pulumi.Context,
	...
	var resource FirewallFilteringApplicationGroups
	err := ctx.ReadResource("zia:Firewall/firewallFilteringApplicationGroups:FirewallFilteringApplicationGroups", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
