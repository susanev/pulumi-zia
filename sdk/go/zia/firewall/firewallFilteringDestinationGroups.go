...
func NewFirewallFilteringDestinationGroups(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zia:Firewall/firewallFilteringDestinationGroups:FirewallFilteringDestinationGroups", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirewallFilteringDestinationGroups(ctx *pulumi.Context,
	...
	var resource FirewallFilteringDestinationGroups
	err := ctx.ReadResource("zia:Firewall/firewallFilteringDestinationGroups:FirewallFilteringDestinationGroups", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Unique identifer for the destination IP group
func (o FirewallFilteringDestinationGroupsOutput) IpDestinationId() pulumi.IntOutput {
	return o.ApplyT(func(v *FirewallFilteringDestinationGroups) pulumi.IntOutput { return v.IpDestinationId }).(pulumi.IntOutput)
}
