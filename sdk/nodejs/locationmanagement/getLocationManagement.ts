...
export function getLocationManagement(args?: GetLocationManagementArgs, opts?: pulumi.InvokeOptions): Promise<GetLocationManagementResult> {
    ...
    return pulumi.runtime.invoke("zia:LocationManagement/getLocationManagement:getLocationManagement", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetLocationManagementResult {
    ...
    readonly vpnCredentials: outputs.LocationManagement.GetLocationManagementVpnCredential[];
    /**
