...
export class LocationManagement extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zia:LocationManagement/locationManagement:LocationManagement';
    ...
    public readonly vpnCredentials!: pulumi.Output<outputs.LocationManagement.LocationManagementVpnCredential[] | undefined>;
    /**
...
export interface LocationManagementState {
    ...
    vpnCredentials?: pulumi.Input<pulumi.Input<inputs.LocationManagement.LocationManagementVpnCredential>[]>;
    /**
     * Enable XFF Forwarding. When set to true, traffic is passed to Zscaler Cloud via the X-Forwarded-For (XFF) header.
     */
