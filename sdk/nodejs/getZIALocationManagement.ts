 ...
 *
 * const example = zia.getZIALocationManagement({
 *     name: "San Jose",
 * });
 * ```
 */
export function getZIALocationManagement(args?: GetZIALocationManagementArgs, opts?: pulumi.InvokeOptions): Promise<GetZIALocationManagementResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zia:index/getZIALocationManagement:getZIALocationManagement", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
 ...
 */
export interface GetZIALocationManagementArgs {
    /**
 ...
 */
export interface GetZIALocationManagementResult {
    /**
    ...
    readonly vpnCredentials: outputs.GetZIALocationManagementVpnCredential[];
    /**
 ...
 * ```
 */
export function getZIALocationManagementOutput(args?: GetZIALocationManagementOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetZIALocationManagementResult> {
    return pulumi.output(args).apply((a: any) => getZIALocationManagement(a, opts))
}

/**
 * A collection of arguments for invoking getZIALocationManagement.
 */
export interface GetZIALocationManagementOutputArgs {
    /**
     * The ID of the location to be exported.
     */
