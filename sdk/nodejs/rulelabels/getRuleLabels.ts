...
export function getRuleLabels(args?: GetRuleLabelsArgs, opts?: pulumi.InvokeOptions): Promise<GetRuleLabelsResult> {
    ...
    return pulumi.runtime.invoke("zia:RuleLabels/getRuleLabels:getRuleLabels", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetRuleLabelsResult {
     ...
     */
    readonly createdBies: outputs.RuleLabels.GetRuleLabelsCreatedBy[];
    /**
     ...
     */
    readonly lastModifiedBies: outputs.RuleLabels.GetRuleLabelsLastModifiedBy[];
    /**
