 ...
 *
 * const test = new zia.ZIADLPWebRules("test", {
 *     action: "ALLOW",
 *     cloudApplications: [
 *         "ZENDESK",
 *         "LUCKY_ORANGE",
 ...
 * ```
 */
export class ZIADLPWebRules extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZIADLPWebRulesState, opts?: pulumi.CustomResourceOptions): ZIADLPWebRules {
        return new ZIADLPWebRules(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zia:index/zIADLPWebRules:ZIADLPWebRules';

    /**
     * Returns true if the given object is an instance of ZIADLPWebRules.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZIADLPWebRules {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZIADLPWebRules.__pulumiType;
    }
     ...
     */
    public readonly auditor!: pulumi.Output<outputs.ZIADLPWebRulesAuditor>;
    /**
     ...
     */
    public readonly departments!: pulumi.Output<outputs.ZIADLPWebRulesDepartments>;
    /**
     ...
     */
    public readonly dlpEngines!: pulumi.Output<outputs.ZIADLPWebRulesDlpEngines>;
    /**
     * The name-ID pairs of the groups that are excluded from the DLP policy rule. Maximum of up to `256` departments.
     */
    public readonly excludedDepartments!: pulumi.Output<outputs.ZIADLPWebRulesExcludedDepartments>;
    /**
     * The name-ID pairs of the groups that are excluded from the DLP policy rule. Maximum of up to `256` groups.
     */
    public readonly excludedGroups!: pulumi.Output<outputs.ZIADLPWebRulesExcludedGroups>;
    /**
     * The name-ID pairs of the users that are excluded from the DLP policy rule. Maximum of up to `256` users.
     */
    public readonly excludedUsers!: pulumi.Output<outputs.ZIADLPWebRulesExcludedUsers>;
    /**
     ...
     */
    public readonly groups!: pulumi.Output<outputs.ZIADLPWebRulesGroups>;
    /**
     * The DLP server, using ICAP, to which the transaction content is forwarded.
     */
    public readonly icapServer!: pulumi.Output<outputs.ZIADLPWebRulesIcapServer>;
    /**
     * The Name-ID pairs of rule labels associated to the DLP policy rule.
     */
    public readonly labels!: pulumi.Output<outputs.ZIADLPWebRulesLabels>;
    /**
     ...
     */
    public readonly locationGroups!: pulumi.Output<outputs.ZIADLPWebRulesLocationGroups>;
    /**
     ...
     */
    public readonly locations!: pulumi.Output<outputs.ZIADLPWebRulesLocations>;
    /**
     ...
     */
    public readonly notificationTemplate!: pulumi.Output<outputs.ZIADLPWebRulesNotificationTemplate>;
    /**
     ...
     */
    public readonly timeWindows!: pulumi.Output<outputs.ZIADLPWebRulesTimeWindows>;
    /**
     * The list of URL categories to which the DLP policy rule must be applied.
     */
    public readonly urlCategories!: pulumi.Output<outputs.ZIADLPWebRulesUrlCategories>;
    /**
     ...
     */
    public readonly users!: pulumi.Output<outputs.ZIADLPWebRulesUsers>;
    /**
     ...
     */
    constructor(name: string, args: ZIADLPWebRulesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZIADLPWebRulesArgs | ZIADLPWebRulesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZIADLPWebRulesState | undefined;
            ...
            const args = argsOrState as ZIADLPWebRulesArgs | undefined;
        ...
        super(ZIADLPWebRules.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZIADLPWebRulesState {
    /**
     * The access privilege for this DLP policy rule based on the admin's state. The supported values are:
     */
     ...
     * The auditor to which the DLP policy rule must be applied.
     */
    auditor?: pulumi.Input<inputs.ZIADLPWebRulesAuditor>;
    /**
     * The list of cloud applications to which the DLP policy rule must be applied. For the complete list of supported cloud applications refer to the  [ZIA API documentation](https://help.zscaler.com/zia/data-loss-prevention#/webDlpRules-post)
     */
     ...
     * The name-ID pairs of the departments that are excluded from the DLP policy rule.
     */
    departments?: pulumi.Input<inputs.ZIADLPWebRulesDepartments>;
    /**
     * The description of the DLP policy rule.
     */
     ...
     * The list of DLP engines to which the DLP policy rule must be applied.
     */
    dlpEngines?: pulumi.Input<inputs.ZIADLPWebRulesDlpEngines>;
    /**
     * The name-ID pairs of the groups that are excluded from the DLP policy rule. Maximum of up to `256` departments.
     */
    excludedDepartments?: pulumi.Input<inputs.ZIADLPWebRulesExcludedDepartments>;
    /**
     * The name-ID pairs of the groups that are excluded from the DLP policy rule. Maximum of up to `256` groups.
     */
    excludedGroups?: pulumi.Input<inputs.ZIADLPWebRulesExcludedGroups>;
    /**
     * The name-ID pairs of the users that are excluded from the DLP policy rule. Maximum of up to `256` users.
     */
    excludedUsers?: pulumi.Input<inputs.ZIADLPWebRulesExcludedUsers>;
    /**
     * The email address of an external auditor to whom DLP email notifications are sent.
     */
     ...
     * The Name-ID pairs of groups to which the DLP policy rule must be applied. Maximum of up to `8` groups. When not used it implies `Any` to apply the rule to all groups.
     */
    groups?: pulumi.Input<inputs.ZIADLPWebRulesGroups>;
    /**
     * The DLP server, using ICAP, to which the transaction content is forwarded.
     */
    icapServer?: pulumi.Input<inputs.ZIADLPWebRulesIcapServer>;
    /**
     * The Name-ID pairs of rule labels associated to the DLP policy rule.
     */
    labels?: pulumi.Input<inputs.ZIADLPWebRulesLabels>;
    /**
     * The Name-ID pairs of locations groups to which the DLP policy rule must be applied. Maximum of up to `32` location groups. When not used it implies `Any` to apply the rule to all location groups.
     */
    locationGroups?: pulumi.Input<inputs.ZIADLPWebRulesLocationGroups>;
    /**
     * The Name-ID pairs of locations to which the DLP policy rule must be applied. Maximum of up to `8` locations. When not used it implies `Any` to apply the rule to all locations.
     */
    locations?: pulumi.Input<inputs.ZIADLPWebRulesLocations>;
    /**
     * The match only criteria for DLP engines.
     */
     ...
     * The template used for DLP notification emails.
     */
    notificationTemplate?: pulumi.Input<inputs.ZIADLPWebRulesNotificationTemplate>;
    /**
     * Enables or disables image file scanning.
     */
     ...
     * The Name-ID pairs of time windows to which the DLP policy rule must be applied. Maximum of up to `2` time intervals. When not used it implies `always` to apply the rule to all time intervals.
     */
    timeWindows?: pulumi.Input<inputs.ZIADLPWebRulesTimeWindows>;
    /**
     * The list of URL categories to which the DLP policy rule must be applied.
     */
    urlCategories?: pulumi.Input<inputs.ZIADLPWebRulesUrlCategories>;
    /**
     * The Name-ID pairs of users to which the DLP policy rule must be applied. Maximum of up to `4` users. When not used it implies `Any` to apply the rule to all users.
     */
    users?: pulumi.Input<inputs.ZIADLPWebRulesUsers>;
    /**
     * Indicates a DLP policy rule without content inspection, when the value is set to true.
     */
 ...
 */
export interface ZIADLPWebRulesArgs {
    /**
     * The access privilege for this DLP policy rule based on the admin's state. The supported values are:
     */
    accessControl?: pulumi.Input<string>;
