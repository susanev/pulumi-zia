 ...
 *
 * const example = zia.getZIATrafficForwardingVPNCredentials({
 ...
 * ```
 */
export function getZIATrafficForwardingVPNCredentials(args?: GetZIATrafficForwardingVPNCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<GetZIATrafficForwardingVPNCredentialsResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zia:index/getZIATrafficForwardingVPNCredentials:getZIATrafficForwardingVPNCredentials", {
        "fqdn": args.fqdn,
        "id": args.id,
 ...
 */
export interface GetZIATrafficForwardingVPNCredentialsArgs {
    /**
 ...
 */
export interface GetZIATrafficForwardingVPNCredentialsResult {
    /**
     ...
     */
    readonly locations: outputs.GetZIATrafficForwardingVPNCredentialsLocation[];
    /**
     * (Set of Object) SD-WAN Partner that manages the location. If a partner does not manage the locaton, this is set to Self.
     */
    readonly managedBies: outputs.GetZIATrafficForwardingVPNCredentialsManagedBy[];
    /**
 ...
 * ```
 */
export function getZIATrafficForwardingVPNCredentialsOutput(args?: GetZIATrafficForwardingVPNCredentialsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetZIATrafficForwardingVPNCredentialsResult> {
    return pulumi.output(args).apply((a: any) => getZIATrafficForwardingVPNCredentials(a, opts))
}

/**
 * A collection of arguments for invoking getZIATrafficForwardingVPNCredentials.
 */
export interface GetZIATrafficForwardingVPNCredentialsOutputArgs {
    /**
     * (String) Fully Qualified Domain Name. Applicable only to `UFQDN` or `XAUTH` (or `HOSTED_MOBILE_USERS`) auth type.
     */
