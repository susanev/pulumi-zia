 ...
 *
 * const zscalerProxyNwServices = zia.getZIAFirewallFilteringNetworkServices({
 ...
 *     name: "Work hours",
 * });
 * const example = new zia.ZIAFirewallFilteringRule("example", {
 *     description: "Example",
 *     action: "ALLOW",
 *     state: "ENABLED",
 *     order: 1,
 ...
 * ```
 */
export class ZIAFirewallFilteringRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZIAFirewallFilteringRuleState, opts?: pulumi.CustomResourceOptions): ZIAFirewallFilteringRule {
        return new ZIAFirewallFilteringRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zia:index/zIAFirewallFilteringRule:ZIAFirewallFilteringRule';

    /**
     * Returns true if the given object is an instance of ZIAFirewallFilteringRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZIAFirewallFilteringRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZIAFirewallFilteringRule.__pulumiType;
    }
     ...
     */
    public readonly appServiceGroups!: pulumi.Output<outputs.ZIAFirewallFilteringRuleAppServiceGroups>;
    /**
     * Application services on which this rule is applied
     */
    public readonly appServices!: pulumi.Output<outputs.ZIAFirewallFilteringRuleAppServices>;
    /**
     ...
     */
    public readonly departments!: pulumi.Output<outputs.ZIAFirewallFilteringRuleDepartments>;
    /**
     ...
     */
    public readonly destIpGroups!: pulumi.Output<outputs.ZIAFirewallFilteringRuleDestIpGroups>;
     ...
     */
    public readonly groups!: pulumi.Output<outputs.ZIAFirewallFilteringRuleGroups>;
    /**
     * Labels that are applicable to the rule.
     */
    public readonly labels!: pulumi.Output<outputs.ZIAFirewallFilteringRuleLabels>;
    public readonly lastModifiedBies!: pulumi.Output<outputs.ZIAFirewallFilteringRuleLastModifiedBy[]>;
     ...
     */
    public readonly locationGroups!: pulumi.Output<outputs.ZIAFirewallFilteringRuleLocationGroups>;
    /**
     * You can manually select up to `8` locations. When not used it implies `Any` to apply the rule to all groups.
     */
    public readonly locations!: pulumi.Output<outputs.ZIAFirewallFilteringRuleLocations>;
    /**
     ...
     */
    public readonly nwApplicationGroups!: pulumi.Output<outputs.ZIAFirewallFilteringRuleNwApplicationGroups>;
    /**
     ...
     */
    public readonly nwServiceGroups!: pulumi.Output<outputs.ZIAFirewallFilteringRuleNwServiceGroups>;
    /**
     ...
     */
    public readonly nwServices!: pulumi.Output<outputs.ZIAFirewallFilteringRuleNwServices>;
    /**
     ...
     */
    public readonly srcIpGroups!: pulumi.Output<outputs.ZIAFirewallFilteringRuleSrcIpGroups>;
    /**
     ...
     */
    public readonly timeWindows!: pulumi.Output<outputs.ZIAFirewallFilteringRuleTimeWindows>;
    /**
     * You can manually select up to `4` general and/or special users. When not used it implies `Any` to apply the rule to all users.
     */
    public readonly users!: pulumi.Output<outputs.ZIAFirewallFilteringRuleUsers>;
     ...
     */
    constructor(name: string, args?: ZIAFirewallFilteringRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZIAFirewallFilteringRuleArgs | ZIAFirewallFilteringRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZIAFirewallFilteringRuleState | undefined;
            ...
            const args = argsOrState as ZIAFirewallFilteringRuleArgs | undefined;
        ...
        super(ZIAFirewallFilteringRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZIAFirewallFilteringRuleState {
     ...
     * Application service groups on which this rule is applied
     */
    appServiceGroups?: pulumi.Input<inputs.ZIAFirewallFilteringRuleAppServiceGroups>;
    /**
     * Application services on which this rule is applied
     */
    appServices?: pulumi.Input<inputs.ZIAFirewallFilteringRuleAppServices>;
    /**
     * If set to true, the default rule is applied
     */
     ...
     * Apply to any number of departments When not used it implies `Any` to apply the rule to all departments.
     */
    departments?: pulumi.Input<inputs.ZIAFirewallFilteringRuleDepartments>;
    /**
     * Enter additional notes or information. The description cannot exceed 10,240 characters.
     */
     ...
     * ** - (Optional) Any number of destination IP address groups that you want to control with this rule.
     */
    destIpGroups?: pulumi.Input<inputs.ZIAFirewallFilteringRuleDestIpGroups>;
    enableFullLogging?: pulumi.Input<boolean>;
    /**
     * You can manually select up to `8` groups. When not used it implies `Any` to apply the rule to all groups.
     */
    groups?: pulumi.Input<inputs.ZIAFirewallFilteringRuleGroups>;
    /**
     * Labels that are applicable to the rule.
     */
    labels?: pulumi.Input<inputs.ZIAFirewallFilteringRuleLabels>;
    lastModifiedBies?: pulumi.Input<pulumi.Input<inputs.ZIAFirewallFilteringRuleLastModifiedBy>[]>;
    lastModifiedTime?: pulumi.Input<number>;
    /**
     * You can manually select up to `32` location groups. When not used it implies `Any` to apply the rule to all location groups.
     */
    locationGroups?: pulumi.Input<inputs.ZIAFirewallFilteringRuleLocationGroups>;
    /**
     * You can manually select up to `8` locations. When not used it implies `Any` to apply the rule to all groups.
     */
    locations?: pulumi.Input<inputs.ZIAFirewallFilteringRuleLocations>;
    /**
     * Name of the network service group
     */
     ...
     * Any number of application groups that you want to control with this rule. The service provides predefined applications that you can group, but not modify
     */
    nwApplicationGroups?: pulumi.Input<inputs.ZIAFirewallFilteringRuleNwApplicationGroups>;
    /**
     * When not used it applies the rule to all applications. The service provides predefined applications, which you can group, but not modify.
     */
     ...
     * Any number of predefined or custom network service groups to which the rule applies.
     */
    nwServiceGroups?: pulumi.Input<inputs.ZIAFirewallFilteringRuleNwServiceGroups>;
    /**
     * When not used it applies the rule to all network services or you can select specific network services. The Zscaler firewall has predefined services and you can configure up to `1,024` additional custom services.
     */
    nwServices?: pulumi.Input<inputs.ZIAFirewallFilteringRuleNwServices>;
    /**
     * Policy rules are evaluated in ascending numerical order (Rule 1 before Rule 2, and so on), and the Rule Order reflects this rule's place in the order.
     */
     ...
     * Any number of source IP address groups that you want to control with this rule.
     */
    srcIpGroups?: pulumi.Input<inputs.ZIAFirewallFilteringRuleSrcIpGroups>;
    /**
     * You can enter individual IP addresses, subnets, or address ranges.
     */
     ...
     * You can manually select up to `2` time intervals. When not used it implies `always` to apply the rule to all time intervals.
     */
    timeWindows?: pulumi.Input<inputs.ZIAFirewallFilteringRuleTimeWindows>;
    /**
     * You can manually select up to `4` general and/or special users. When not used it implies `Any` to apply the rule to all users.
     */
    users?: pulumi.Input<inputs.ZIAFirewallFilteringRuleUsers>;
}

/**
 * The set of arguments for constructing a ZIAFirewallFilteringRule resource.
 */
export interface ZIAFirewallFilteringRuleArgs {
    accessControl?: pulumi.Input<string>;
    /**
     * Choose the action of the service when packets match the rule. The following actions are accepted: `ALLOW`, `BLOCK_DROP`, `BLOCK_RESET`, `BLOCK_ICMP`, `EVAL_NWAPP`
     */
