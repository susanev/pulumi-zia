...
export function getDLPDictionaries(args?: GetDLPDictionariesArgs, opts?: pulumi.InvokeOptions): Promise<GetDLPDictionariesResult> {
    ...
    return pulumi.runtime.invoke("zia:DLP/getDLPDictionaries:getDLPDictionaries", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetDLPDictionariesResult {
    ...
    readonly exactDataMatchDetails: outputs.DLP.GetDLPDictionariesExactDataMatchDetail[];
    readonly id: number;
    readonly idmProfileMatchAccuracies: outputs.DLP.GetDLPDictionariesIdmProfileMatchAccuracy[];
    ...
    readonly patterns: outputs.DLP.GetDLPDictionariesPattern[];
    readonly phrases: outputs.DLP.GetDLPDictionariesPhrase[];
