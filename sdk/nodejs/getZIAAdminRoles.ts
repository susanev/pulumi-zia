 ...
 *
 * const example = zia.getZIAAdminRoles({
 *     name: "Super Admin",
 * });
 * ```
 */
export function getZIAAdminRoles(args?: GetZIAAdminRolesArgs, opts?: pulumi.InvokeOptions): Promise<GetZIAAdminRolesResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zia:index/getZIAAdminRoles:getZIAAdminRoles", {
        "name": args.name,
    }, opts);
}
 ...
 */
export interface GetZIAAdminRolesArgs {
    /**
 ...
 */
export interface GetZIAAdminRolesResult {
    /**
     * (String)
     */
 ...
 * ```
 */
export function getZIAAdminRolesOutput(args?: GetZIAAdminRolesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetZIAAdminRolesResult> {
    return pulumi.output(args).apply((a: any) => getZIAAdminRoles(a, opts))
}

/**
 * A collection of arguments for invoking getZIAAdminRoles.
 */
export interface GetZIAAdminRolesOutputArgs {
    /**
     * The name of the Admin role to be exported.
     */
