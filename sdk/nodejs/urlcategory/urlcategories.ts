...
export class URLCategories extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zia:URLCategory/uRLCategories:URLCategories';
     ...
     */
    public readonly scopes!: pulumi.Output<outputs.URLCategory.URLCategoriesScope[] | undefined>;
    /**
     ...
     */
    public readonly urlKeywordCounts!: pulumi.Output<outputs.URLCategory.URLCategoriesUrlKeywordCounts>;
    /**
...
export interface URLCategoriesState {
     ...
     * Scope of the custom categories.
     */
    scopes?: pulumi.Input<pulumi.Input<inputs.URLCategory.URLCategoriesScope>[]>;
    /**
     * Super Category of the URL category. This field is required when creating custom URL categories.
     */
     ...
     * URL and keyword counts for the category.
     */
    urlKeywordCounts?: pulumi.Input<inputs.URLCategory.URLCategoriesUrlKeywordCounts>;
    /**
     * Custom URLs to add to a URL category. Up to 25,000 custom URLs can be added per organization across all categories (including bandwidth classes).
     */
