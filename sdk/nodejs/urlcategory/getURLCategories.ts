...
export function getURLCategories(args?: GetURLCategoriesArgs, opts?: pulumi.InvokeOptions): Promise<GetURLCategoriesResult> {
    ...
    return pulumi.runtime.invoke("zia:URLCategory/getURLCategories:getURLCategories", {
...
export interface GetURLCategoriesResult {
     ...
     */
    readonly scopes: outputs.URLCategory.GetURLCategoriesScope[];
    /**
     * (String)
     */
     ...
     */
    readonly urlKeywordCounts: outputs.URLCategory.GetURLCategoriesUrlKeywordCount[];
    /**
