 ...
 *
 * const adamAshcroft = zia.getZIAUserManagement({
 *     name: "Adam Ashcroft",
 * });
 * ```
 */
export function getZIAUserManagement(args?: GetZIAUserManagementArgs, opts?: pulumi.InvokeOptions): Promise<GetZIAUserManagementResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zia:index/getZIAUserManagement:getZIAUserManagement", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
 ...
 */
export interface GetZIAUserManagementArgs {
    /**
 ...
 */
export interface GetZIAUserManagementResult {
    /**
     ...
     */
    readonly departments: outputs.GetZIAUserManagementDepartment[];
    /**
     ...
     */
    readonly groups: outputs.GetZIAUserManagementGroup[];
    /**
 ...
 * ```
 */
export function getZIAUserManagementOutput(args?: GetZIAUserManagementOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetZIAUserManagementResult> {
    return pulumi.output(args).apply((a: any) => getZIAUserManagement(a, opts))
}

/**
 * A collection of arguments for invoking getZIAUserManagement.
 */
export interface GetZIAUserManagementOutputArgs {
    /**
     * The ID of the time window resource.
     */
