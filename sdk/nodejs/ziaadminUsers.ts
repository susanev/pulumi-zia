 ...
 *
 * const superAdmin = zia.getZIAAdminRoles({
 *     name: "Super Admin",
 * });
 * const engineering = zia.getZIADepartmentManagement({
 *     name: "Engineering",
 * });
 * const johnSmith = new zia.ZIAAdminUsers("johnSmith", {
 ...
 * ```
 */
export class ZIAAdminUsers extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZIAAdminUsersState, opts?: pulumi.CustomResourceOptions): ZIAAdminUsers {
        return new ZIAAdminUsers(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zia:index/zIAAdminUsers:ZIAAdminUsers';

    /**
     * Returns true if the given object is an instance of ZIAAdminUsers.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZIAAdminUsers {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZIAAdminUsers.__pulumiType;
    }
     ...
     */
    public readonly adminScopes!: pulumi.Output<outputs.ZIAAdminUsersAdminScope[]>;
    /**
     ...
     */
    public readonly roles!: pulumi.Output<outputs.ZIAAdminUsersRole[]>;
    /**
     * The username of the admin user to be exported.
     */
     ...
     */
    constructor(name: string, args: ZIAAdminUsersArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZIAAdminUsersArgs | ZIAAdminUsersState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZIAAdminUsersState | undefined;
            ...
            const args = argsOrState as ZIAAdminUsersArgs | undefined;
        ...
        super(ZIAAdminUsers.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZIAAdminUsersState {
    adminId?: pulumi.Input<number>;
    /**
     * The admin's scope. A scope is required for admins, but not applicable to auditors. This attribute is subject to change.
     */
    adminScopes?: pulumi.Input<pulumi.Input<inputs.ZIAAdminUsersAdminScope>[]>;
    /**
     * Additional information about the admin or auditor.
     */
     ...
     * Role of the admin. This is not required for an auditor.
     */
    roles?: pulumi.Input<pulumi.Input<inputs.ZIAAdminUsersRole>[]>;
    /**
     * The username of the admin user to be exported.
     */
 ...
 */
export interface ZIAAdminUsersArgs {
    /**
     * The admin's scope. A scope is required for admins, but not applicable to auditors. This attribute is subject to change.
     */
    adminScopes?: pulumi.Input<pulumi.Input<inputs.ZIAAdminUsersAdminScope>[]>;
