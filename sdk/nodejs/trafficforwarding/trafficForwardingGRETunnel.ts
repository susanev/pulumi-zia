...
export class TrafficForwardingGRETunnel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zia:TrafficForwarding/trafficForwardingGRETunnel:TrafficForwardingGRETunnel';
    ...
    public /*out*/ readonly lastModifiedBies!: pulumi.Output<outputs.TrafficForwarding.TrafficForwardingGRETunnelLastModifiedBy[]>;
    /**
     * **` (Optional) The primary destination data center and virtual IP address (VIP) of the GRE tunnel.
     */
    public readonly primaryDestVips!: pulumi.Output<outputs.TrafficForwarding.TrafficForwardingGRETunnelPrimaryDestVip[]>;
    /**
     * The secondary destination data center and virtual IP address (VIP) of the GRE tunnel.
     */
    public readonly secondaryDestVips!: pulumi.Output<outputs.TrafficForwarding.TrafficForwardingGRETunnelSecondaryDestVip[]>;
    /**
...
export interface TrafficForwardingGRETunnelState {
    ...
    lastModifiedBies?: pulumi.Input<pulumi.Input<inputs.TrafficForwarding.TrafficForwardingGRETunnelLastModifiedBy>[]>;
    /**
     * **` (Optional) The primary destination data center and virtual IP address (VIP) of the GRE tunnel.
     */
    primaryDestVips?: pulumi.Input<pulumi.Input<inputs.TrafficForwarding.TrafficForwardingGRETunnelPrimaryDestVip>[]>;
    /**
     * The secondary destination data center and virtual IP address (VIP) of the GRE tunnel.
     */
    secondaryDestVips?: pulumi.Input<pulumi.Input<inputs.TrafficForwarding.TrafficForwardingGRETunnelSecondaryDestVip>[]>;
    /**
     * The source IP address of the GRE tunnel. This is typically a static IP address in the organization or SD-WAN. This IP address must be provisioned within the Zscaler service using the /staticIP endpoint.
     */
