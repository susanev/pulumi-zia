...
export function getTrafficForwardingStaticIP(args?: GetTrafficForwardingStaticIPArgs, opts?: pulumi.InvokeOptions): Promise<GetTrafficForwardingStaticIPResult> {
    ...
    return pulumi.runtime.invoke("zia:TrafficForwarding/getTrafficForwardingStaticIP:getTrafficForwardingStaticIP", {
...
export interface GetTrafficForwardingStaticIPResult {
     ...
     * (Set of Object)
     */
    readonly lastModifiedBies: outputs.TrafficForwarding.GetTrafficForwardingStaticIPLastModifiedBy[];
    /**
     ...
     * (Set of Object)
     */
    readonly managedBies: outputs.TrafficForwarding.GetTrafficForwardingStaticIPManagedBy[];
    /**
