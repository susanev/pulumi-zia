...
export class TrafficForwardingStaticIP extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zia:TrafficForwarding/trafficForwardingStaticIP:TrafficForwardingStaticIP';
     ...
     */
    public readonly lastModifiedBies!: pulumi.Output<outputs.TrafficForwarding.TrafficForwardingStaticIPLastModifiedBy[]>;
    /**
     ...
     * This is an immutable reference to an entity. which mainly consists of id and name
     */
    public readonly managedBies!: pulumi.Output<outputs.TrafficForwarding.TrafficForwardingStaticIPManagedBy[]>;
    /**
...
export interface TrafficForwardingStaticIPState {
     ...
     * This is an immutable reference to an entity. which mainly consists of id and name
     */
    lastModifiedBies?: pulumi.Input<pulumi.Input<inputs.TrafficForwarding.TrafficForwardingStaticIPLastModifiedBy>[]>;
    /**
     * Required only if the geoOverride attribute is set. Latitude with 7 digit precision after decimal point, ranges between -90 and 90 degrees.
     */
     ...
     * This is an immutable reference to an entity. which mainly consists of id and name
     */
    managedBies?: pulumi.Input<pulumi.Input<inputs.TrafficForwarding.TrafficForwardingStaticIPManagedBy>[]>;
    /**
     * Indicates whether a non-RFC 1918 IP address is publicly routable. This attribute is ignored if there is no ZIA Private Service Edge associated to the organization.
     */
