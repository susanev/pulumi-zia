...
export function getAdminUsers(args?: GetAdminUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetAdminUsersResult> {
    ...
    return pulumi.runtime.invoke("zia:AdminUsers/getAdminUsers:getAdminUsers", {
        "id": args.id,
...
export interface GetAdminUsersResult {
     ...
     */
    readonly adminScopes: outputs.AdminUsers.GetAdminUsersAdminScope[];
    /**
     ...
     * (List of Object)
     */
    readonly execMobileAppTokens: outputs.AdminUsers.GetAdminUsersExecMobileAppToken[];
    /**
     ...
     */
    readonly roles: outputs.AdminUsers.GetAdminUsersRole[];
