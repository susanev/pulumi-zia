 ...
 *
 * // URL filtering rules
 * const blockStreaming = new zia.ZIAURLFilteringRules("blockStreaming", {
 *     action: "BLOCK",
 ...
 * ```
 */
export class ZIAURLFilteringRules extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZIAURLFilteringRulesState, opts?: pulumi.CustomResourceOptions): ZIAURLFilteringRules {
        return new ZIAURLFilteringRules(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zia:index/zIAURLFilteringRules:ZIAURLFilteringRules';

    /**
     * Returns true if the given object is an instance of ZIAURLFilteringRules.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZIAURLFilteringRules {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZIAURLFilteringRules.__pulumiType;
    }
     ...
     */
    public readonly departments!: pulumi.Output<outputs.ZIAURLFilteringRulesDepartments>;
    /**
     ...
     */
    public readonly deviceGroups!: pulumi.Output<outputs.ZIAURLFilteringRulesDeviceGroups>;
    /**
     ...
     * list of devices
     */
    public readonly devices!: pulumi.Output<outputs.ZIAURLFilteringRulesDevices>;
    /**
     ...
     */
    public readonly groups!: pulumi.Output<outputs.ZIAURLFilteringRulesGroups>;
    /**
     * list of labels
     */
    public readonly labels!: pulumi.Output<outputs.ZIAURLFilteringRulesLabels>;
    /**
     * Who modified the rule last
     */
    public readonly lastModifiedBies!: pulumi.Output<outputs.ZIAURLFilteringRulesLastModifiedBy[]>;
    /**
     ...
     */
    public readonly locationGroups!: pulumi.Output<outputs.ZIAURLFilteringRulesLocationGroups>;
    /**
     * The locations to which the Firewall Filtering policy rule applies
     */
    public readonly locations!: pulumi.Output<outputs.ZIAURLFilteringRulesLocations>;
    /**
     ...
     */
    public readonly overrideGroups!: pulumi.Output<outputs.ZIAURLFilteringRulesOverrideGroups>;
    /**
     ...
     */
    public readonly overrideUsers!: pulumi.Output<outputs.ZIAURLFilteringRulesOverrideUsers>;
    /**
     ...
     */
    public readonly timeWindows!: pulumi.Output<outputs.ZIAURLFilteringRulesTimeWindows>;
    /**
     ...
     */
    public readonly users!: pulumi.Output<outputs.ZIAURLFilteringRulesUsers>;
    /**
     ...
     */
    constructor(name: string, args: ZIAURLFilteringRulesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZIAURLFilteringRulesArgs | ZIAURLFilteringRulesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZIAURLFilteringRulesState | undefined;
            ...
            const args = argsOrState as ZIAURLFilteringRulesArgs | undefined;
        ...
        super(ZIAURLFilteringRules.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ZIAURLFilteringRulesState {
    /**
     * Action taken when traffic matches rule criteria. Supported values: `ANY`, `NONE`, `BLOCK`, `CAUTION`, `ALLOW`, `ICAP_RESPONSE`
     */
     ...
     * The departments to which the Firewall Filtering policy rule applies
     */
    departments?: pulumi.Input<inputs.ZIAURLFilteringRulesDepartments>;
    /**
     * Additional information about the rule
     */
     ...
     * list of device groups
     */
    deviceGroups?: pulumi.Input<inputs.ZIAURLFilteringRulesDeviceGroups>;
    /**
     * List of device trust levels for which the rule must be applied. This field is applicable for devices that are managed using Zscaler Client Connector. The trust levels are assigned to the devices based on your posture configurations in the Zscaler Client Connector Portal. If no value is set, this field is ignored during the policy evaluation. Supported values: `ANY`, `UNKNOWN_DEVICETRUSTLEVEL`, `LOW_TRUST`, `MEDIUM_TRUST`, `HIGH_TRUST`
     */
     ...
     * list of devices
     */
    devices?: pulumi.Input<inputs.ZIAURLFilteringRulesDevices>;
    /**
     * URL of end user notification page to be displayed when the rule is matched. Not applicable if either 'overrideUsers' or 'overrideGroups' is specified.
     */
     ...
     * The groups to which the Firewall Filtering policy rule applies
     */
    groups?: pulumi.Input<inputs.ZIAURLFilteringRulesGroups>;
    /**
     * list of labels
     */
    labels?: pulumi.Input<inputs.ZIAURLFilteringRulesLabels>;
    /**
     * Who modified the rule last
     */
    lastModifiedBies?: pulumi.Input<pulumi.Input<inputs.ZIAURLFilteringRulesLastModifiedBy>[]>;
    /**
     * When the rule was last modified
     */
     ...
     * The location groups to which the Firewall Filtering policy rule applies
     */
    locationGroups?: pulumi.Input<inputs.ZIAURLFilteringRulesLocationGroups>;
    /**
     * The locations to which the Firewall Filtering policy rule applies
     */
    locations?: pulumi.Input<inputs.ZIAURLFilteringRulesLocations>;
    /**
     * Name of the Firewall Filtering policy rule
     */
     ...
     * Name-ID pairs of users for which this rule can be overridden. Applicable only if blockOverride is set to `true`, action is `BLOCK` and overrideGroups is not set.If this overrideUsers is not set, `BLOCK` action can be overridden for any group.
     */
    overrideGroups?: pulumi.Input<inputs.ZIAURLFilteringRulesOverrideGroups>;
    /**
     * Name-ID pairs of users for which this rule can be overridden. Applicable only if blockOverride is set to `true`, action is `BLOCK` and overrideGroups is not set.If this overrideUsers is not set, `BLOCK` action can be overridden for any user.
     */
    overrideUsers?: pulumi.Input<inputs.ZIAURLFilteringRulesOverrideUsers>;
    /**
     * Protocol criteria. Supported values: `SMRULEF_ZPA_BROKERS_RULE`, `ANY_RULE`, `TCP_RULE`, `UDP_RULE`, `DOHTTPS_RULE`, `TUNNELSSL_RULE`, `HTTP_PROXY`, `FOHTTP_RULE`, `FTP_RULE`, `HTTPS_RULE`, `HTTP_RULE`, `SSL_RULE`, `TUNNEL_RULE`.
     */
     ...
     * The time interval in which the Firewall Filtering policy rule applies
     */
    timeWindows?: pulumi.Input<inputs.ZIAURLFilteringRulesTimeWindows>;
    /**
     * List of URL categories for which rule must be applied
     */
     ...
     * The users to which the Firewall Filtering policy rule applies
     */
    users?: pulumi.Input<inputs.ZIAURLFilteringRulesUsers>;
    /**
     * If `enforceTimeValidity` is set to true, the URL Filtering rule will cease to be valid on this end date and time.
     */
 ...
 */
export interface ZIAURLFilteringRulesArgs {
    /**
     * Action taken when traffic matches rule criteria. Supported values: `ANY`, `NONE`, `BLOCK`, `CAUTION`, `ALLOW`, `ICAP_RESPONSE`
     */
    action?: pulumi.Input<string>;
