...
export class UserManagement extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zia:Users/userManagement:UserManagement';
     ...
     */
    public readonly department!: pulumi.Output<outputs.Users.UserManagementDepartment | undefined>;
    /**
     ...
     */
    public readonly groups!: pulumi.Output<outputs.Users.UserManagementGroups>;
    /**
...
export interface UserManagementState {
     ...
     * Department a user belongs to
     */
    department?: pulumi.Input<inputs.Users.UserManagementDepartment>;
    /**
     * User email consists of a user name and domain name. It does not have to be a valid email address, but it must be unique and its domain must belong to the organization.
     */
     ...
     * List of Groups a user belongs to. Groups are used in policies.
     */
    groups?: pulumi.Input<inputs.Users.UserManagementGroups>;
    /**
     * User name. This appears when choosing users for policies.
     */
