...
export class FirewallFilteringNetworkServices extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zia:Firewall/firewallFilteringNetworkServices:FirewallFilteringNetworkServices';
     ...
     */
    public readonly destTcpPorts!: pulumi.Output<outputs.Firewall.FirewallFilteringNetworkServicesDestTcpPort[] | undefined>;
    /**
     * The UDP source port number (example: 50) or port number range (example: 1000-1050), if any, that is used by the network service.
     */
    public readonly destUdpPorts!: pulumi.Output<outputs.Firewall.FirewallFilteringNetworkServicesDestUdpPort[] | undefined>;
    /**
     * (Optional
     */
     ...
     */
    public readonly srcTcpPorts!: pulumi.Output<outputs.Firewall.FirewallFilteringNetworkServicesSrcTcpPort[] | undefined>;
    /**
     * The UDP source port number (example: 50) or port number range (example: 1000-1050), if any, that is used by the network service.
     */
    public readonly srcUdpPorts!: pulumi.Output<outputs.Firewall.FirewallFilteringNetworkServicesSrcUdpPort[] | undefined>;
    /**
...
export interface FirewallFilteringNetworkServicesState {
     ...
     * The TCP destination port number (example: 50) or port number range (example: 1000-1050), if any, that is used by the network service.
     */
    destTcpPorts?: pulumi.Input<pulumi.Input<inputs.Firewall.FirewallFilteringNetworkServicesDestTcpPort>[]>;
    /**
     * The UDP source port number (example: 50) or port number range (example: 1000-1050), if any, that is used by the network service.
     */
    destUdpPorts?: pulumi.Input<pulumi.Input<inputs.Firewall.FirewallFilteringNetworkServicesDestUdpPort>[]>;
    /**
     * (Optional
     */
     ...
     * The TCP source port number (example: 50) or port number range (example: 1000-1050), if any, that is used by the network service
     */
    srcTcpPorts?: pulumi.Input<pulumi.Input<inputs.Firewall.FirewallFilteringNetworkServicesSrcTcpPort>[]>;
    /**
     * The UDP source port number (example: 50) or port number range (example: 1000-1050), if any, that is used by the network service.
     */
    srcUdpPorts?: pulumi.Input<pulumi.Input<inputs.Firewall.FirewallFilteringNetworkServicesSrcUdpPort>[]>;
    /**
     * The following values are supported: `"ICMP_ANY`, `"UDP_ANY"`, `"TCP_ANY"`, `"OTHER_NETWORK_SERVICE"`, `"DNS"`, `"NETBIOS"`, `"FTP"`, `"GNUTELLA"`, `"H_323"`, `"HTTP"`, `"HTTPS"`, `"IKE"`, `"IMAP"`, `"ILS"`, `"IKE_NAT"`, `"IRC"`, `"LDAP"`, `"QUIC"`, `"TDS"`, `"NETMEETING"`, `"NFS"`, `"NTP"`, `"SIP"`, `"SNMP"`, `"SMB"`, `"SMTP"`, `"SSH"`, `"SYSLOG"`, `"TELNET"`, `"TRACEROUTE"`, `"POP3"`, `"PPTP"`, `"RADIUS"`, `"REAL_MEDIA"`, `"RTSP"`, `"VNC"`, `"WHOIS"`, `"KERBEROS_SEC"`, `"TACACS"`, `"SNMPTRAP"`, `"NMAP"`, `"RSYNC"`, `"L2TP"`, `"HTTP_PROXY"`, `"PC_ANYWHERE"`, `"MSN"`, `"ECHO"`, `"AIM"`, `"IDENT"`, `"YMSG"`, `"SCCP"`, `"MGCP_UA"`, `"MGCP_CA"`, `"VDO_LIVE"`, `"OPENVPN"`, `"TFTP"`, `"FTPS_IMPLICIT"`, `"ZSCALER_PROXY_NW_SERVICES"`, `"GRE_PROTOCOL"`, `"ESP_PROTOCOL"`, `"DHCP"`
     */
