...
export function getFirewallFilteringNetworkServices(args?: GetFirewallFilteringNetworkServicesArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallFilteringNetworkServicesResult> {
    ...
    return pulumi.runtime.invoke("zia:Firewall/getFirewallFilteringNetworkServices:getFirewallFilteringNetworkServices", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
...
export interface GetFirewallFilteringNetworkServicesResult {
     ...
     */
    readonly destTcpPorts: outputs.Firewall.GetFirewallFilteringNetworkServicesDestTcpPort[];
    /**
     * The UDP source port number (example: 50) or port number range (example: 1000-1050), if any, that is used by the network service.
     */
    readonly destUdpPorts: outputs.Firewall.GetFirewallFilteringNetworkServicesDestUdpPort[];
    readonly id: number;
    /**
     * (Bool) - Default: false
     */
     ...
     */
    readonly srcTcpPorts: outputs.Firewall.GetFirewallFilteringNetworkServicesSrcTcpPort[];
    /**
     * The UDP source port number (example: 50) or port number range (example: 1000-1050), if any, that is used by the network service.
     */
    readonly srcUdpPorts: outputs.Firewall.GetFirewallFilteringNetworkServicesSrcUdpPort[];
    readonly tag: string;
    /**
