 ...
 *
 * const example = zia.getZIAFirewallFilteringRule({
 *     name: "Office 365 One Click Rule",
 * });
 * ```
 */
export function getZIAFirewallFilteringRule(args?: GetZIAFirewallFilteringRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetZIAFirewallFilteringRuleResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zia:index/getZIAFirewallFilteringRule:getZIAFirewallFilteringRule", {
        "action": args.action,
 ...
 */
export interface GetZIAFirewallFilteringRuleArgs {
    /**
 ...
 */
export interface GetZIAFirewallFilteringRuleResult {
    /**
     * (String)
     */
     ...
     */
    readonly appServiceGroups: outputs.GetZIAFirewallFilteringRuleAppServiceGroup[];
    /**
     * Application services on which this rule is applied
     */
    readonly appServices: outputs.GetZIAFirewallFilteringRuleAppService[];
    /**
     * (Boolean)
     */
     ...
     */
    readonly departments: outputs.GetZIAFirewallFilteringRuleDepartment[];
    /**
     * (Optional) Enter additional notes or information. The description cannot exceed 10,240 characters.
     */
     ...
     */
    readonly groups: outputs.GetZIAFirewallFilteringRuleGroup[];
    /**
     ...
     */
    readonly labels: outputs.GetZIAFirewallFilteringRuleLabel[];
    readonly lastModifiedBies: outputs.GetZIAFirewallFilteringRuleLastModifiedBy[];
    /**
     * (Number)
     */
     ...
     */
    readonly locationGroups: outputs.GetZIAFirewallFilteringRuleLocationGroup[];
    /**
     * (Optional) You can manually select up to `8` locations. When not used it implies `Any` to apply the rule to all groups.
     */
    readonly locations: outputs.GetZIAFirewallFilteringRuleLocation[];
    /**
     ...
     */
    readonly nwApplicationGroups: outputs.GetZIAFirewallFilteringRuleNwApplicationGroup[];
    /**
     ...
     */
    readonly nwServiceGroups: outputs.GetZIAFirewallFilteringRuleNwServiceGroup[];
    /**
     ...
     */
    readonly nwServices: outputs.GetZIAFirewallFilteringRuleNwService[];
    /**
     ...
     */
    readonly timeWindows: outputs.GetZIAFirewallFilteringRuleTimeWindow[];
    /**
     ...
     */
    readonly users: outputs.GetZIAFirewallFilteringRuleUser[];
}
/**
 * Use the **zia_firewall_filtering_rule** data source to get information about a cloud firewall rule available in the Zscaler Internet Access cloud firewall.
 *
 ...
 * ```
 */
export function getZIAFirewallFilteringRuleOutput(args?: GetZIAFirewallFilteringRuleOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetZIAFirewallFilteringRuleResult> {
    return pulumi.output(args).apply((a: any) => getZIAFirewallFilteringRule(a, opts))
}

/**
 * A collection of arguments for invoking getZIAFirewallFilteringRule.
 */
export interface GetZIAFirewallFilteringRuleOutputArgs {
    /**
     * (Optional) Choose the action of the service when packets match the rule. The following actions are accepted: `ALLOW`, `BLOCK_DROP`, `BLOCK_RESET`, `BLOCK_ICMP`, `EVAL_NWAPP`
     */
