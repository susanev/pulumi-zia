...
export function getLocationGroups(args?: GetLocationGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetLocationGroupsResult> {
    ...
    return pulumi.runtime.invoke("zia:LocationGroups/getLocationGroups:getLocationGroups", {
...
export interface GetLocationGroupsArgs {
     ...
     */
    dynamicLocationGroupCriterias?: inputs.LocationGroups.GetLocationGroupsDynamicLocationGroupCriteria[];
    /**
     * Location group name
     */
    name?: string;
...
export interface GetLocationGroupsResult {
     ...
     * (Block Set) Dynamic location group information.
     */
    readonly dynamicLocationGroupCriterias?: outputs.LocationGroups.GetLocationGroupsDynamicLocationGroupCriteria[];
    /**
     ...
     * (List of Object)
     */
    readonly lastModUsers: outputs.LocationGroups.GetLocationGroupsLastModUser[];
    /**
     ...
     */
    readonly locations: outputs.LocationGroups.GetLocationGroupsLocation[];
    /**
...
export interface GetLocationGroupsOutputArgs {
     ...
     * (Block Set) Dynamic location group information.
     */
    dynamicLocationGroupCriterias?: pulumi.Input<pulumi.Input<inputs.LocationGroups.GetLocationGroupsDynamicLocationGroupCriteriaArgs>[]>;
    /**
     * Location group name
     */
