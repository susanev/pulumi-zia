 ...
 *
 * const example = zia.getZIAURLCategories({
 *     id: "CUSTOM_08",
 * });
 * ```
 */
export function getZIAURLCategories(args?: GetZIAURLCategoriesArgs, opts?: pulumi.InvokeOptions): Promise<GetZIAURLCategoriesResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zia:index/getZIAURLCategories:getZIAURLCategories", {
 ...
 */
export interface GetZIAURLCategoriesArgs {
    /**
 ...
 */
export interface GetZIAURLCategoriesResult {
    /**
     * (String) Name of the URL category. This is only required for custom URL categories.
     */
     ...
     */
    readonly scopes: outputs.GetZIAURLCategoriesScope[];
    /**
     * (String)
     */
     ...
     */
    readonly urlKeywordCounts: outputs.GetZIAURLCategoriesUrlKeywordCount[];
    /**
 ...
 * ```
 */
export function getZIAURLCategoriesOutput(args?: GetZIAURLCategoriesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetZIAURLCategoriesResult> {
    return pulumi.output(args).apply((a: any) => getZIAURLCategories(a, opts))
}

/**
 * A collection of arguments for invoking getZIAURLCategories.
 */
export interface GetZIAURLCategoriesOutputArgs {
    /**
     * (String) Name of the URL category. This is only required for custom URL categories.
     */
