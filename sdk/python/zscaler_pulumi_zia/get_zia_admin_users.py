...
__all__ = [
    'GetZIAAdminUsersResult',
    'AwaitableGetZIAAdminUsersResult',
    'get_zia_admin_users',
    'get_zia_admin_users_output',
]

@pulumi.output_type
class GetZIAAdminUsersResult:
    """
    ...
    def admin_scopes(self) -> Sequence['outputs.GetZIAAdminUsersAdminScopeResult']:
        """
    ...
    def exec_mobile_app_tokens(self) -> Sequence['outputs.GetZIAAdminUsersExecMobileAppTokenResult']:
        """
        (List of Object)
        """
    ...
    @property
    @pulumi.getter
    def roles(self) -> Sequence['outputs.GetZIAAdminUsersRoleResult']:
        """
...
class AwaitableGetZIAAdminUsersResult(GetZIAAdminUsersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZIAAdminUsersResult(
...
def get_zia_admin_users(id: Optional[int] = None,
                        login_name: Optional[str] = None,
                        username: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZIAAdminUsersResult:
    """
    ...
    john_doe = zia.get_zia_admin_users(login_name="john.doe@example.com")
    ```
    ...
    john_doe = zia.get_zia_admin_users(username="John Doe")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zia:index/getZIAAdminUsers:getZIAAdminUsers', __args__, opts=opts, typ=GetZIAAdminUsersResult).value

    return AwaitableGetZIAAdminUsersResult(
...
@_utilities.lift_output_func(get_zia_admin_users)
def get_zia_admin_users_output(id: Optional[pulumi.Input[Optional[int]]] = None,
                               login_name: Optional[pulumi.Input[Optional[str]]] = None,
                               username: Optional[pulumi.Input[Optional[str]]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZIAAdminUsersResult]:
    """
    Use the **zia_admin_users** data source to get information about an admin user account created in the Zscaler Internet Access cloud or via the API. This data source can then be associated with a ZIA administrator role.
