...
__all__ = [
    'GetZIATrafficForwardingGRETunnelResult',
    'AwaitableGetZIATrafficForwardingGRETunnelResult',
    'get_zia_traffic_forwarding_gre_tunnel',
    'get_zia_traffic_forwarding_gre_tunnel_output',
]

@pulumi.output_type
class GetZIATrafficForwardingGRETunnelResult:
    """
    ...
    def last_modified_bies(self) -> Sequence['outputs.GetZIATrafficForwardingGRETunnelLastModifiedByResult']:
        return pulumi.get(self, "last_modified_bies")

    @property
    @pulumi.getter(name="managedBies")
    def managed_bies(self) -> Sequence['outputs.GetZIATrafficForwardingGRETunnelManagedByResult']:
        return pulumi.get(self, "managed_bies")

    @property
    @pulumi.getter(name="primaryDestVips")
    def primary_dest_vips(self) -> Sequence['outputs.GetZIATrafficForwardingGRETunnelPrimaryDestVipResult']:
        return pulumi.get(self, "primary_dest_vips")

    @property
    @pulumi.getter(name="secondaryDestVips")
    def secondary_dest_vips(self) -> Sequence['outputs.GetZIATrafficForwardingGRETunnelSecondaryDestVipResult']:
...
class AwaitableGetZIATrafficForwardingGRETunnelResult(GetZIATrafficForwardingGRETunnelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZIATrafficForwardingGRETunnelResult(
...
def get_zia_traffic_forwarding_gre_tunnel(id: Optional[int] = None,
                                          source_ip: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZIATrafficForwardingGRETunnelResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('zia:index/getZIATrafficForwardingGRETunnel:getZIATrafficForwardingGRETunnel', __args__, opts=opts, typ=GetZIATrafficForwardingGRETunnelResult).value

    return AwaitableGetZIATrafficForwardingGRETunnelResult(
...
@_utilities.lift_output_func(get_zia_traffic_forwarding_gre_tunnel)
def get_zia_traffic_forwarding_gre_tunnel_output(id: Optional[pulumi.Input[Optional[int]]] = None,
                                                 source_ip: Optional[pulumi.Input[Optional[str]]] = None,
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZIATrafficForwardingGRETunnelResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
