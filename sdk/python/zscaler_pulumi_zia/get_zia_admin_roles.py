...
__all__ = [
    'GetZIAAdminRolesResult',
    'AwaitableGetZIAAdminRolesResult',
    'get_zia_admin_roles',
    'get_zia_admin_roles_output',
]

@pulumi.output_type
class GetZIAAdminRolesResult:
    """
...
class AwaitableGetZIAAdminRolesResult(GetZIAAdminRolesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZIAAdminRolesResult(
...
def get_zia_admin_roles(name: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZIAAdminRolesResult:
    """
    ...
    example = zia.get_zia_admin_roles(name="Super Admin")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zia:index/getZIAAdminRoles:getZIAAdminRoles', __args__, opts=opts, typ=GetZIAAdminRolesResult).value

    return AwaitableGetZIAAdminRolesResult(
...
@_utilities.lift_output_func(get_zia_admin_roles)
def get_zia_admin_roles_output(name: Optional[pulumi.Input[Optional[str]]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZIAAdminRolesResult]:
    """
    Use the **zia_admin_roles** data source to get information about an admin role created in the Zscaler Internet Access cloud or via the API. This data source can then be associated with a ZIA administrator account.
