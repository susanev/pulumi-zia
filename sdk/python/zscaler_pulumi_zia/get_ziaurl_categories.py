...
__all__ = [
    'GetZIAURLCategoriesResult',
    'AwaitableGetZIAURLCategoriesResult',
    'get_ziaurl_categories',
    'get_ziaurl_categories_output',
]

@pulumi.output_type
class GetZIAURLCategoriesResult:
    """
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Sequence['outputs.GetZIAURLCategoriesScopeResult']:
        """
    ...
    def url_keyword_counts(self) -> Sequence['outputs.GetZIAURLCategoriesUrlKeywordCountResult']:
        """
...
class AwaitableGetZIAURLCategoriesResult(GetZIAURLCategoriesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetZIAURLCategoriesResult(
...
def get_ziaurl_categories(configured_name: Optional[str] = None,
                          custom_category: Optional[bool] = None,
                          custom_ip_ranges_count: Optional[int] = None,
                          id: Optional[str] = None,
                          super_category: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZIAURLCategoriesResult:
    """
    ...
    example = zia.get_ziaurl_categories(id="CUSTOM_08")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zia:index/getZIAURLCategories:getZIAURLCategories', __args__, opts=opts, typ=GetZIAURLCategoriesResult).value

    return AwaitableGetZIAURLCategoriesResult(
...
@_utilities.lift_output_func(get_ziaurl_categories)
def get_ziaurl_categories_output(configured_name: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetZIAURLCategoriesResult]:
    """
    Use the **zia_url_categories** data source to get information about all or custom URL categories. By default, the response includes keywords.
