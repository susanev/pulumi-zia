...
namespace zscaler.PulumiPackage.Zia.URLFiltering
{
    /// <summary>
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:URLFiltering/uRLFilteringRules:URLFilteringRules")]
    public partial class URLFilteringRules : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.URLFilteringRulesLastModifiedBy>> LastModifiedBies { get; private set; } = null!;
        ...
        public URLFilteringRules(string name, URLFilteringRulesArgs args, CustomResourceOptions? options = null)
            : base("zia:URLFiltering/uRLFilteringRules:URLFilteringRules", name, args ?? new URLFilteringRulesArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private URLFilteringRules(string name, Input<string> id, URLFilteringRulesState? state = null, CustomResourceOptions? options = null)
            : base("zia:URLFiltering/uRLFilteringRules:URLFilteringRules", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class URLFilteringRulesArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.URLFilteringRulesLastModifiedByArgs>? _lastModifiedBies;

        /// <summary>
        /// Who modified the rule last
        /// </summary>
        public InputList<Inputs.URLFilteringRulesLastModifiedByArgs> LastModifiedBies
        {
            get => _lastModifiedBies ?? (_lastModifiedBies = new InputList<Inputs.URLFilteringRulesLastModifiedByArgs>());
    ...
    public sealed class URLFilteringRulesState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("lastModifiedBies")]
        private InputList<Inputs.URLFilteringRulesLastModifiedByGetArgs>? _lastModifiedBies;

        /// <summary>
        /// Who modified the rule last
        /// </summary>
        public InputList<Inputs.URLFilteringRulesLastModifiedByGetArgs> LastModifiedBies
        {
            get => _lastModifiedBies ?? (_lastModifiedBies = new InputList<Inputs.URLFilteringRulesLastModifiedByGetArgs>());
            set => _lastModifiedBies = value;
        }
