...
{
    [ZiaResourceType("zia:SecuritySettings/securitySettings:SecuritySettings")]
    public partial class SecuritySettings : global::Pulumi.CustomResource
    {
        ...
        public SecuritySettings(string name, SecuritySettingsArgs? args = null, CustomResourceOptions? options = null)
            : base("zia:SecuritySettings/securitySettings:SecuritySettings", name, args ?? new SecuritySettingsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecuritySettings(string name, Input<string> id, SecuritySettingsState? state = null, CustomResourceOptions? options = null)
            : base("zia:SecuritySettings/securitySettings:SecuritySettings", name, state, MakeResourceOptions(options, id))
        {
        }
