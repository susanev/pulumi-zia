...
namespace zscaler.PulumiPackage.Zia.DLP
{
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:DLP/dLPNotificationTemplates:DLPNotificationTemplates")]
    public partial class DLPNotificationTemplates : global::Pulumi.CustomResource
    {
        ...
        public DLPNotificationTemplates(string name, DLPNotificationTemplatesArgs args, CustomResourceOptions? options = null)
            : base("zia:DLP/dLPNotificationTemplates:DLPNotificationTemplates", name, args ?? new DLPNotificationTemplatesArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DLPNotificationTemplates(string name, Input<string> id, DLPNotificationTemplatesState? state = null, CustomResourceOptions? options = null)
            : base("zia:DLP/dLPNotificationTemplates:DLPNotificationTemplates", name, state, MakeResourceOptions(options, id))
        {
        }
