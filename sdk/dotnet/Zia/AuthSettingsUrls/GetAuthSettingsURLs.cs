...
namespace zscaler.PulumiPackage.Zia.AuthSettingsUrls
{
    public static class GetAuthSettingsURLs
    {
        ...
        public static Task<GetAuthSettingsURLsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthSettingsURLsResult>("zia:AuthSettingsUrls/getAuthSettingsURLs:getAuthSettingsURLs", InvokeArgs.Empty, options.WithDefaults());
    }
