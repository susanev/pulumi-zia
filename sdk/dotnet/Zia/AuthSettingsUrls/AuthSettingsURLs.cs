...
namespace zscaler.PulumiPackage.Zia.AuthSettingsUrls
{
    /// <summary>
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:AuthSettingsUrls/authSettingsURLs:AuthSettingsURLs")]
    public partial class AuthSettingsURLs : global::Pulumi.CustomResource
    {
        ...
        public AuthSettingsURLs(string name, AuthSettingsURLsArgs? args = null, CustomResourceOptions? options = null)
            : base("zia:AuthSettingsUrls/authSettingsURLs:AuthSettingsURLs", name, args ?? new AuthSettingsURLsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthSettingsURLs(string name, Input<string> id, AuthSettingsURLsState? state = null, CustomResourceOptions? options = null)
            : base("zia:AuthSettingsUrls/authSettingsURLs:AuthSettingsURLs", name, state, MakeResourceOptions(options, id))
        {
        }
