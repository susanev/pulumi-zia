...
namespace zscaler.PulumiPackage.Zia
{
    ...
    /// {
    ///     var example = new Zia.ZIAURLCategories("example", new()
    ///     {
    ...
    ///         Scopes = new[]
    ///         {
    ///             new Zia.Inputs.ZIAURLCategoriesScopeArgs
    ///             {
    ///                 Type = "LOCATION",
    ///                 ScopeEntities = new Zia.Inputs.ZIAURLCategoriesScopeScopeEntitiesArgs
    ///                 {
    ///                     Ids = new[]
    ///                     {
    ...
    ///                     },
    ///                 },
    ///                 ScopeGroupMemberEntities = new Zia.Inputs.ZIAURLCategoriesScopeScopeGroupMemberEntitiesArgs
    ///                 {
    ///                     Ids = new[]
    ///                     {
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:index/zIAURLCategories:ZIAURLCategories")]
    public partial class ZIAURLCategories : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("scopes")]
        public Output<ImmutableArray<Outputs.ZIAURLCategoriesScope>> Scopes { get; private set; } = null!;
        ...
        [Output("urlCategoryId")]
        public Output<string> UrlCategoryId { get; private set; } = null!;

        /// <summary>
        /// URL and keyword counts for the category.
        /// </summary>
        [Output("urlKeywordCounts")]
        public Output<Outputs.ZIAURLCategoriesUrlKeywordCounts> UrlKeywordCounts { get; private set; } = null!;
        ...
        public ZIAURLCategories(string name, ZIAURLCategoriesArgs? args = null, CustomResourceOptions? options = null)
            : base("zia:index/zIAURLCategories:ZIAURLCategories", name, args ?? new ZIAURLCategoriesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZIAURLCategories(string name, Input<string> id, ZIAURLCategoriesState? state = null, CustomResourceOptions? options = null)
            : base("zia:index/zIAURLCategories:ZIAURLCategories", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ZIAURLCategories Get(string name, Input<string> id, ZIAURLCategoriesState? state = null, CustomResourceOptions? options = null)
        {
            return new ZIAURLCategories(name, id, state, options);
        }
    }

    public sealed class ZIAURLCategoriesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of the URL category. This is only required for custom URL categories.
        /// </summary>
        ...
        [Input("scopes")]
        private InputList<Inputs.ZIAURLCategoriesScopeArgs>? _scopes;

        /// <summary>
        /// Scope of the custom categories.
        /// </summary>
        public InputList<Inputs.ZIAURLCategoriesScopeArgs> Scopes
        {
            get => _scopes ?? (_scopes = new InputList<Inputs.ZIAURLCategoriesScopeArgs>());
            set => _scopes = value;
        }
        ...
        public Input<Inputs.ZIAURLCategoriesUrlKeywordCountsArgs>? UrlKeywordCounts { get; set; }
        ...
        public ZIAURLCategoriesArgs()
        {
        }
        public static new ZIAURLCategoriesArgs Empty => new ZIAURLCategoriesArgs();
    }

    public sealed class ZIAURLCategoriesState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of the URL category. This is only required for custom URL categories.
        /// </summary>
        ...
        [Input("scopes")]
        private InputList<Inputs.ZIAURLCategoriesScopeGetArgs>? _scopes;

        /// <summary>
        /// Scope of the custom categories.
        /// </summary>
        public InputList<Inputs.ZIAURLCategoriesScopeGetArgs> Scopes
        {
            get => _scopes ?? (_scopes = new InputList<Inputs.ZIAURLCategoriesScopeGetArgs>());
            set => _scopes = value;
        }
        ...
        [Input("urlCategoryId")]
        public Input<string>? UrlCategoryId { get; set; }

        /// <summary>
        /// URL and keyword counts for the category.
        /// </summary>
        [Input("urlKeywordCounts")]
        public Input<Inputs.ZIAURLCategoriesUrlKeywordCountsGetArgs>? UrlKeywordCounts { get; set; }
        ...
        public ZIAURLCategoriesState()
        {
        }
        public static new ZIAURLCategoriesState Empty => new ZIAURLCategoriesState();
    }
}
