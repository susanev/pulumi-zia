...
namespace zscaler.PulumiPackage.Zia
{
    ...
    /// {
    ///     var example = new Zia.ZIADLPNotificationTemplates("example", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:index/zIADLPNotificationTemplates:ZIADLPNotificationTemplates")]
    public partial class ZIADLPNotificationTemplates : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ZIADLPNotificationTemplates(string name, ZIADLPNotificationTemplatesArgs args, CustomResourceOptions? options = null)
            : base("zia:index/zIADLPNotificationTemplates:ZIADLPNotificationTemplates", name, args ?? new ZIADLPNotificationTemplatesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZIADLPNotificationTemplates(string name, Input<string> id, ZIADLPNotificationTemplatesState? state = null, CustomResourceOptions? options = null)
            : base("zia:index/zIADLPNotificationTemplates:ZIADLPNotificationTemplates", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ZIADLPNotificationTemplates Get(string name, Input<string> id, ZIADLPNotificationTemplatesState? state = null, CustomResourceOptions? options = null)
        {
            return new ZIADLPNotificationTemplates(name, id, state, options);
        }
    }

    public sealed class ZIADLPNotificationTemplatesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// If set to true, the content that is violation is attached to the DLP notification email.
        /// </summary>
        ...
        public ZIADLPNotificationTemplatesArgs()
        {
        }
        public static new ZIADLPNotificationTemplatesArgs Empty => new ZIADLPNotificationTemplatesArgs();
    }

    public sealed class ZIADLPNotificationTemplatesState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// If set to true, the content that is violation is attached to the DLP notification email.
        /// </summary>
        ...
        public ZIADLPNotificationTemplatesState()
        {
        }
        public static new ZIADLPNotificationTemplatesState Empty => new ZIADLPNotificationTemplatesState();
    }
}
