...
namespace zscaler.PulumiPackage.Zia.Groups
{
    public static class GetGroupManagement
    {
        public static Task<GetGroupManagementResult> InvokeAsync(GetGroupManagementArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupManagementResult>("zia:Groups/getGroupManagement:getGroupManagement", args ?? new GetGroupManagementArgs(), options.WithDefaults());

        public static Output<GetGroupManagementResult> Invoke(GetGroupManagementInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupManagementResult>("zia:Groups/getGroupManagement:getGroupManagement", args ?? new GetGroupManagementInvokeArgs(), options.WithDefaults());
    }
