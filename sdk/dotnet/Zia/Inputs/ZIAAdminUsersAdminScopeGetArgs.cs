...
namespace zscaler.PulumiPackage.Zia.Inputs
{
    ...
    public sealed class ZIAAdminUsersAdminScopeGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Based on the admin scope type, the entities can be the ID/name pair of departments, locations, or location groups.
        /// </summary>
        [Input("scopeEntities")]
        public Input<Inputs.ZIAAdminUsersAdminScopeScopeEntitiesGetArgs>? ScopeEntities { get; set; }
        ...
        public Input<Inputs.ZIAAdminUsersAdminScopeScopeGroupMemberEntitiesGetArgs>? ScopeGroupMemberEntities { get; set; }
        ...
        public ZIAAdminUsersAdminScopeGetArgs()
        {
        }
        public static new ZIAAdminUsersAdminScopeGetArgs Empty => new ZIAAdminUsersAdminScopeGetArgs();
    }
}
