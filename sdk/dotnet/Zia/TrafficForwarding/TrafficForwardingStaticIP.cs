...
namespace zscaler.PulumiPackage.Zia.TrafficForwarding
{
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:TrafficForwarding/trafficForwardingStaticIP:TrafficForwardingStaticIP")]
    public partial class TrafficForwardingStaticIP : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.TrafficForwardingStaticIPLastModifiedBy>> LastModifiedBies { get; private set; } = null!;
        ...
        /// </summary>
        [Output("managedBies")]
        public Output<ImmutableArray<Outputs.TrafficForwardingStaticIPManagedBy>> ManagedBies { get; private set; } = null!;
        ...
        public TrafficForwardingStaticIP(string name, TrafficForwardingStaticIPArgs args, CustomResourceOptions? options = null)
            : base("zia:TrafficForwarding/trafficForwardingStaticIP:TrafficForwardingStaticIP", name, args ?? new TrafficForwardingStaticIPArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private TrafficForwardingStaticIP(string name, Input<string> id, TrafficForwardingStaticIPState? state = null, CustomResourceOptions? options = null)
            : base("zia:TrafficForwarding/trafficForwardingStaticIP:TrafficForwardingStaticIP", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TrafficForwardingStaticIPArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.TrafficForwardingStaticIPLastModifiedByArgs>? _lastModifiedBies;

        /// <summary>
        /// This is an immutable reference to an entity. which mainly consists of id and name
        /// </summary>
        public InputList<Inputs.TrafficForwardingStaticIPLastModifiedByArgs> LastModifiedBies
        {
            get => _lastModifiedBies ?? (_lastModifiedBies = new InputList<Inputs.TrafficForwardingStaticIPLastModifiedByArgs>());
        ...
        [Input("managedBies")]
        private InputList<Inputs.TrafficForwardingStaticIPManagedByArgs>? _managedBies;

        /// <summary>
        /// This is an immutable reference to an entity. which mainly consists of id and name
        /// </summary>
        public InputList<Inputs.TrafficForwardingStaticIPManagedByArgs> ManagedBies
        {
            get => _managedBies ?? (_managedBies = new InputList<Inputs.TrafficForwardingStaticIPManagedByArgs>());
    ...
    public sealed class TrafficForwardingStaticIPState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("lastModifiedBies")]
        private InputList<Inputs.TrafficForwardingStaticIPLastModifiedByGetArgs>? _lastModifiedBies;

        /// <summary>
        /// This is an immutable reference to an entity. which mainly consists of id and name
        /// </summary>
        public InputList<Inputs.TrafficForwardingStaticIPLastModifiedByGetArgs> LastModifiedBies
        {
            get => _lastModifiedBies ?? (_lastModifiedBies = new InputList<Inputs.TrafficForwardingStaticIPLastModifiedByGetArgs>());
            set => _lastModifiedBies = value;
        }
        ...
        [Input("managedBies")]
        private InputList<Inputs.TrafficForwardingStaticIPManagedByGetArgs>? _managedBies;

        /// <summary>
        /// This is an immutable reference to an entity. which mainly consists of id and name
        /// </summary>
        public InputList<Inputs.TrafficForwardingStaticIPManagedByGetArgs> ManagedBies
        {
            get => _managedBies ?? (_managedBies = new InputList<Inputs.TrafficForwardingStaticIPManagedByGetArgs>());
            set => _managedBies = value;
        }
