...
namespace zscaler.PulumiPackage.Zia.TrafficForwarding
{
    public static class GetTrafficForwardingGRETunnel
    {
        public static Task<GetTrafficForwardingGRETunnelResult> InvokeAsync(GetTrafficForwardingGRETunnelArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrafficForwardingGRETunnelResult>("zia:TrafficForwarding/getTrafficForwardingGRETunnel:getTrafficForwardingGRETunnel", args ?? new GetTrafficForwardingGRETunnelArgs(), options.WithDefaults());
        ...
        public static Output<GetTrafficForwardingGRETunnelResult> Invoke(GetTrafficForwardingGRETunnelInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrafficForwardingGRETunnelResult>("zia:TrafficForwarding/getTrafficForwardingGRETunnel:getTrafficForwardingGRETunnel", args ?? new GetTrafficForwardingGRETunnelInvokeArgs(), options.WithDefaults());
    }
