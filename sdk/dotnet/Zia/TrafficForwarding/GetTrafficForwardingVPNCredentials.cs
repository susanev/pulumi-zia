...
namespace zscaler.PulumiPackage.Zia.TrafficForwarding
{
    public static class GetTrafficForwardingVPNCredentials
    {
        ...
        public static Task<GetTrafficForwardingVPNCredentialsResult> InvokeAsync(GetTrafficForwardingVPNCredentialsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrafficForwardingVPNCredentialsResult>("zia:TrafficForwarding/getTrafficForwardingVPNCredentials:getTrafficForwardingVPNCredentials", args ?? new GetTrafficForwardingVPNCredentialsArgs(), options.WithDefaults());
        ...
        public static Output<GetTrafficForwardingVPNCredentialsResult> Invoke(GetTrafficForwardingVPNCredentialsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrafficForwardingVPNCredentialsResult>("zia:TrafficForwarding/getTrafficForwardingVPNCredentials:getTrafficForwardingVPNCredentials", args ?? new GetTrafficForwardingVPNCredentialsInvokeArgs(), options.WithDefaults());
    }
