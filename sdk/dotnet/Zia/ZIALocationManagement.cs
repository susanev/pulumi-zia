...
namespace zscaler.PulumiPackage.Zia
{
    ...
    /// {
    ///     var usaSjc37ZIATrafficForwardingVPNCredentials = new Zia.ZIATrafficForwardingVPNCredentials("usaSjc37ZIATrafficForwardingVPNCredentials", new()
    ///     {
    ///         Type = "UFQDN",
    ...
    ///     });
    /// 
    ///     var usaSjc37ZIATrafficForwardingStaticIP = new Zia.ZIATrafficForwardingStaticIP("usaSjc37ZIATrafficForwardingStaticIP", new()
    ///     {
    ///         IpAddress = "1.1.1.1",
    ///         RoutableIp = true,
    ...
    ///     var usaSjc37ZIALocationManagement = new Zia.ZIALocationManagement("usaSjc37ZIALocationManagement", new()
    ///     {
    ...
    ///         VpnCredentials = new[]
    ///         {
    ///             new Zia.Inputs.ZIALocationManagementVpnCredentialArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:index/zIALocationManagement:ZIALocationManagement")]
    public partial class ZIALocationManagement : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.ZIALocationManagementVpnCredential>> VpnCredentials { get; private set; } = null!;
        ...
        public ZIALocationManagement(string name, ZIALocationManagementArgs? args = null, CustomResourceOptions? options = null)
            : base("zia:index/zIALocationManagement:ZIALocationManagement", name, args ?? new ZIALocationManagementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ZIALocationManagement(string name, Input<string> id, ZIALocationManagementState? state = null, CustomResourceOptions? options = null)
            : base("zia:index/zIALocationManagement:ZIALocationManagement", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ZIALocationManagement Get(string name, Input<string> id, ZIALocationManagementState? state = null, CustomResourceOptions? options = null)
        {
            return new ZIALocationManagement(name, id, state, options);
        }
    }

    public sealed class ZIALocationManagementArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// For First Time AUP Behavior, Block Internet Access. When set, all internet access (including non-HTTP traffic) is disabled until the user accepts the AUP.
        /// </summary>
        ...
        private InputList<Inputs.ZIALocationManagementVpnCredentialArgs>? _vpnCredentials;
        public InputList<Inputs.ZIALocationManagementVpnCredentialArgs> VpnCredentials
        {
            get => _vpnCredentials ?? (_vpnCredentials = new InputList<Inputs.ZIALocationManagementVpnCredentialArgs>());
        ...
        public ZIALocationManagementArgs()
        {
        }
        public static new ZIALocationManagementArgs Empty => new ZIALocationManagementArgs();
    }

    public sealed class ZIALocationManagementState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// For First Time AUP Behavior, Block Internet Access. When set, all internet access (including non-HTTP traffic) is disabled until the user accepts the AUP.
        /// </summary>
        ...
        [Input("vpnCredentials")]
        private InputList<Inputs.ZIALocationManagementVpnCredentialGetArgs>? _vpnCredentials;
        public InputList<Inputs.ZIALocationManagementVpnCredentialGetArgs> VpnCredentials
        {
            get => _vpnCredentials ?? (_vpnCredentials = new InputList<Inputs.ZIALocationManagementVpnCredentialGetArgs>());
            set => _vpnCredentials = value;
        }
        ...
        public ZIALocationManagementState()
        {
        }
        public static new ZIALocationManagementState Empty => new ZIALocationManagementState();
    }
}
