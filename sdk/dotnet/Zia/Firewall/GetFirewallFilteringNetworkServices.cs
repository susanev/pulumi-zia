...
namespace zscaler.PulumiPackage.Zia.Firewall
{
    public static class GetFirewallFilteringNetworkServices
    {
        ...
        public static Task<GetFirewallFilteringNetworkServicesResult> InvokeAsync(GetFirewallFilteringNetworkServicesArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallFilteringNetworkServicesResult>("zia:Firewall/getFirewallFilteringNetworkServices:getFirewallFilteringNetworkServices", args ?? new GetFirewallFilteringNetworkServicesArgs(), options.WithDefaults());
        ...
        public static Output<GetFirewallFilteringNetworkServicesResult> Invoke(GetFirewallFilteringNetworkServicesInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallFilteringNetworkServicesResult>("zia:Firewall/getFirewallFilteringNetworkServices:getFirewallFilteringNetworkServices", args ?? new GetFirewallFilteringNetworkServicesInvokeArgs(), options.WithDefaults());
    }
