...
namespace zscaler.PulumiPackage.Zia.Firewall
{
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:Firewall/firewallFilteringNetworkServices:FirewallFilteringNetworkServices")]
    public partial class FirewallFilteringNetworkServices : global::Pulumi.CustomResource
    {
        ...
        public FirewallFilteringNetworkServices(string name, FirewallFilteringNetworkServicesArgs? args = null, CustomResourceOptions? options = null)
            : base("zia:Firewall/firewallFilteringNetworkServices:FirewallFilteringNetworkServices", name, args ?? new FirewallFilteringNetworkServicesArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private FirewallFilteringNetworkServices(string name, Input<string> id, FirewallFilteringNetworkServicesState? state = null, CustomResourceOptions? options = null)
            : base("zia:Firewall/firewallFilteringNetworkServices:FirewallFilteringNetworkServices", name, state, MakeResourceOptions(options, id))
        {
        }
