...
namespace zscaler.PulumiPackage.Zia.Firewall
{
    public static class GetFirewallFilteringDestinationGroups
    {
        ...
        public static Task<GetFirewallFilteringDestinationGroupsResult> InvokeAsync(GetFirewallFilteringDestinationGroupsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallFilteringDestinationGroupsResult>("zia:Firewall/getFirewallFilteringDestinationGroups:getFirewallFilteringDestinationGroups", args ?? new GetFirewallFilteringDestinationGroupsArgs(), options.WithDefaults());
        ...
        public static Output<GetFirewallFilteringDestinationGroupsResult> Invoke(GetFirewallFilteringDestinationGroupsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallFilteringDestinationGroupsResult>("zia:Firewall/getFirewallFilteringDestinationGroups:getFirewallFilteringDestinationGroups", args ?? new GetFirewallFilteringDestinationGroupsInvokeArgs(), options.WithDefaults());
    }
