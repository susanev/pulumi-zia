...
namespace zscaler.PulumiPackage.Zia.Firewall
{
    public static class GetFirewallFilteringApplicationGroups
    {
        ...
        public static Task<GetFirewallFilteringApplicationGroupsResult> InvokeAsync(GetFirewallFilteringApplicationGroupsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFirewallFilteringApplicationGroupsResult>("zia:Firewall/getFirewallFilteringApplicationGroups:getFirewallFilteringApplicationGroups", args ?? new GetFirewallFilteringApplicationGroupsArgs(), options.WithDefaults());
        ...
        public static Output<GetFirewallFilteringApplicationGroupsResult> Invoke(GetFirewallFilteringApplicationGroupsInvokeArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFirewallFilteringApplicationGroupsResult>("zia:Firewall/getFirewallFilteringApplicationGroups:getFirewallFilteringApplicationGroups", args ?? new GetFirewallFilteringApplicationGroupsInvokeArgs(), options.WithDefaults());
    }
