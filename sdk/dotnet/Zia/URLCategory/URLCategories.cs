...
namespace zscaler.PulumiPackage.Zia.URLCategory
{
    /// <summary>
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:URLCategory/uRLCategories:URLCategories")]
    public partial class URLCategories : global::Pulumi.CustomResource
    {
        ...
        public URLCategories(string name, URLCategoriesArgs? args = null, CustomResourceOptions? options = null)
            : base("zia:URLCategory/uRLCategories:URLCategories", name, args ?? new URLCategoriesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private URLCategories(string name, Input<string> id, URLCategoriesState? state = null, CustomResourceOptions? options = null)
            : base("zia:URLCategory/uRLCategories:URLCategories", name, state, MakeResourceOptions(options, id))
        {
        }
