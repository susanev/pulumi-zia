...
namespace zscaler.PulumiPackage.Zia.LocationManagement
{
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:LocationManagement/locationManagement:LocationManagement")]
    public partial class LocationManagement : global::Pulumi.CustomResource
    {
        ...
        public LocationManagement(string name, LocationManagementArgs? args = null, CustomResourceOptions? options = null)
            : base("zia:LocationManagement/locationManagement:LocationManagement", name, args ?? new LocationManagementArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LocationManagement(string name, Input<string> id, LocationManagementState? state = null, CustomResourceOptions? options = null)
            : base("zia:LocationManagement/locationManagement:LocationManagement", name, state, MakeResourceOptions(options, id))
        {
        }
